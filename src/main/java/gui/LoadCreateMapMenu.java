...
public class LoadCreateMapMenu extends Application implements TransitionInterface {
    private Stage stage;
    private final ArrayList<Transition> transitions = new ArrayList<>();
    private final Scene sceneToUse;

    public LoadCreateMapMenu(Scene sceneToUse) {
    ...
    public void start(Stage stage) {
        ...
        buttonLoadMap.setOnAction(e -> {
            ...
            if (scenarioMap != null) quitSceneTransition(() -> new ScenarioMenu(scenarioMap).start(stage), vboxButtons);
        });
