...
public class Launcher {
    ...
    private final static int NUMBER_OF_GAMES = 21; // Change this to change the number of games to run
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (url != null) {
            ...
            for (int i = 20; i < NUMBER_OF_GAMES; i++) {
                int finalI = i;
    ...
    private static void runGame(int i, URL url) {
        ...
        controller.init();
        controller.engine();
        System.out.println(i + " finished " + controller.getTime());
    }
